...
public class NaiveDefenseExperiment implements BasicSingleExperiment{
	...
	public BasicSingleExperiment createNewOne() {
		NaiveDefenseExperiment exp = new NaiveDefenseExperiment();
	...
	public void run() throws IOException {
		...
		Double attMSE = ProbUtils.MeanSquareErrForAttacker(allPoints, probX, tweetPos, squareSize);
		Double attMAE = ProbUtils.MeanAbsErrForAttacker(allPoints, probX, tweetPos, squareSize);
		...
		for(int i = 1; i <= numOfStep; i++){
			...
			attMSE = ProbUtils.MeanSquareErrForAttacker(allPoints, probX, tweetPos, squareSize);
			attMAE = ProbUtils.MeanAbsErrForAttacker(allPoints, probX, tweetPos, squareSize);
